...
class Graphene:
    ...
    def make_system(self):
        ...
        def potential(site):
            ...
            lt_term = np.tanh((x + self.L/4)/self.d)
            rt_term = np.tanh((x - self.L/4)/self.d)
        ...
        leadl[graphene.shape(lead_shape, (0, 0))] = 0
        leadl[graphene.neighbors()] = nn_hopping

        leadr = kwant.Builder(symr)
        leadr[graphene.shape(lead_shape, (0, 0))] = 0
